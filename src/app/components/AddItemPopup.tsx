...
const AddItemPopup: React.FC<AddItemPopupProps> = ({ onClose, onSave }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="relative bg-white p-6 rounded-lg shadow-lg w-[90vw] max-w-md">
        <button
          onClick={onClose}
        ...
        <h2 className="text-xl font-bold mb-4">점검 내역 추가</h2>
        <div className="mb-4">
          <label className="block font-semibold text-gray-700">점검 사항</label>
          <input
            type="text"
            value={name}
